...
describe("Check out items", () => {
  it("Check out items is rendered and responds to mouse interaction", () => {
    ...
    cy.get('[data-cy="banner"]')
      .eq(0)
      .should("have.text", "Title 4Title 4 af Author 4");
    cy.get('[data-cy="banner"]')
      .eq(1)
      .should("have.text", "Title 3Title 3 af Author 3");
    cy.get('[data-cy="banner"]')
      .eq(2)
      .should("have.text", "Check out messageTitle 2 af Author 2");
    cy.get('[data-cy="banner"]')
      .eq(3)
      .should("have.text", "Henter informationer1");
  ...
  it("Check out items responds to barcode scanner", () => {
    ...
    cy.get("@actionHandlerStub").should("be.calledWith", "checkOutItem", {
