...
describe("Status", () => {
  it("Status is rendered and responds to mouse interaction", () => {
    ...
    cy.get('[data-cy="overdue-books"]').should(
      "have.css",
      "background-color",
      "rgb(233, 67, 67)"
    );
    cy.get('[data-cy="overdue-books"]')
      .find(".top")
      .should("have.text", "2 bøger skal afleveres");
    cy.get('[data-cy="overdue-books"]')
      .find(".item")
      .eq(0)
      .should("have.text", "Jeg har et museumUden forfatter");
    cy.get('[data-cy="overdue-books"]')
      .find(".item")
      .eq(1)
      .should("have.text", "Jeg har et museumAf Forfatter");
    cy.get('[data-cy="book-banner"]')
      .eq(0)
      .should("have.text", "Hvad finder jeg i sø og åAf Mandahl-Barth, G.");
    cy.get('[data-cy="book-banner"]')
      .eq(1)
      .should("have.text", "En bogtitelAf En forfatter");
    cy.get('[data-cy="book-banner"]')
      .eq(2)
      .should("have.text", "En bogAf En forfatter");
    cy.get('[data-cy="book-banner"]')
      .eq(0)
    ...
    cy.get('[data-cy="banner-list-header"]')
      .eq(0)
      .should("have.text", "Aktuelle lån3");
    cy.get('[data-cy="banner-list-header"]')
      .eq(1)
      .should("have.text", "Reservationer1");
    cy.get('[data-cy="banner-list-header"]')
      .eq(2)
      .should("have.text", "Klar til afhentning1");
  });
